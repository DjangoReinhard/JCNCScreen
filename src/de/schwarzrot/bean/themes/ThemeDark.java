...
public class ThemeDark extends AbstractTheme {
   public ThemeDark(Map<String, Object> settings) {
      ...
      settings.put("JogButton:gradient.start", Color.ORANGE);
      settings.put("JogButton:gradient.end", Color.DARK_GRAY);
      settings.put("JogButton:gradient.disabled.start", Color.GRAY);
      settings.put("JogButton:gradient.disabled.end", Color.DARK_GRAY);
      settings.put("JogButton:gradient.selected.start", Color.GRAY);
      settings.put("JogButton:gradient.selected.end", Color.ORANGE);
      settings.put("JogButton:border", Color.GRAY);
