...
public class ThemeGtk extends AbstractTheme {
   public ThemeGtk(Map<String, Object> settings) {
      ...
      settings.put("Axis:background", UIManager.get("Label.background"));
      ...
      settings.put("DRO:grid.color", Color.LIGHT_GRAY);
      ...
      settings.put("Tool:desc.foreground", UIManager.get("TextField.foreground"));
      ...
      settings.put("Tool:info.foreground", UIManager.get("TextField.foreground"));
