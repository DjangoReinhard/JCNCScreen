...
public class GCodeStylesDark implements IStyles {
   public GCodeStylesDark() {
      ...
      attr.addAttribute(StyleConstants.Foreground, Color.GRAY);
      ...
      attr = new SimpleAttributeSet(ctx.addAttribute(ctx.getEmptySet(), StyleConstants.FontSize, 20));
      attr.addAttribute(StyleConstants.Foreground, Color.CYAN);
      map.put(GCodeSource.Pos, attr);

      attr = new SimpleAttributeSet(ctx.addAttribute(ctx.getEmptySet(), StyleConstants.FontSize, 20));
      attr.addAttribute(StyleConstants.Foreground, Color.LIGHT_GRAY);
